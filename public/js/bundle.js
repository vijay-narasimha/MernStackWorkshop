...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidmlqYXktMjgiLCJhIjoiY2wwN2premNqMDR0NTNqazZoN25nNmtydiJ9.n8ml0HEMZiVrzkV4Cdr0Vg';
...
var stripe = Stripe('pk_test_51KhVXISAGHX2FkPUlGdyhuadwv9TGkmnnVrann1lkNSvK32kk1PtmZXE3sEJZbnFFeUFZwsTUbjxKcGXa703cJu6003iZ5N0IZ');
...
if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); //id doesnt work
